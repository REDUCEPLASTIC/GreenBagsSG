...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Start Experience overlay hook with smooth transitions
    ...
    if (experienceOverlay && experienceStartBtn) {
        // Initialize: Hide hero initially if overlay is present
        if (heroSection && !experienceOverlay.classList.contains('hidden')) {
            heroSection.classList.add('hidden-initially');
            body.style.overflow = 'hidden'; // Prevent scrolling during overlay
        }
